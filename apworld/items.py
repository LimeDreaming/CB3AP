...
ITEM_NAME_TO_ID = {
    ...
    "Yellow Gem" : 142005,
    "Purple Gem" : 142006,
    "Sapphire Relic" : 142007,
    "Gold Relic" : 142008,
    "Platinum Relic" : 142009,
    #"Aku Aku" : 142010,
    "Life Bundle" : 142011,
    "Wumpa Fruit Bundle" : 142012,
    "Loose Live Trap" : 142013,
    "Loose Wumpa Trap" : 142014, 
    "Big Crash Trap" : 142015,
    "Small Crash Trap" : 142016,
    "No Lives Trap" : 142017,
    "Jetpack Controls Trap" : 142018,
    "Body Slam" : 142019,
    "Double Jump" : 142020,
    "Tornado Spin" : 142021,
    "Bazooka" : 142022,
...
DEFAULT_ITEM_CLASSIFICATIONS = {
    ...
    "Sapphire Relic" : ItemClassification.progression,
    "Gold Relic" : ItemClassification.progression,
    "Platinum Relic" : ItemClassification.progression,
...
def create_all_items(world: Crash3World) -> None:
    ...
    itempool: list[Item] = [
        world.create_item("Blue Gem"),
        world.create_item("Red Gem"),
        world.create_item("Green Gem"),
    ...
    for i in range(1, 31):
        # F-String nutzen, damit die Zahl korrekt in den Text eingefügt wird
        itempool += [world.create_item(f"Level {i} Sapphire Relic")]
        itempool += [world.create_item(f"Level {i} Gold Relic")]
        itempool += [world.create_item(f"Level {i} Platinum Relic")]
