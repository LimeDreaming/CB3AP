...
class Crash3World(World):
    ...
    def generate_early(self) -> None:
        if hasattr(self.options, "randomize_warp_destinations") and self.options.randomize_warp_destinations.value:
            if hasattr(self.multiworld, "re_gen_passthrough"):
                if "Crash Bandicoot: Warped" in self.multiworld.re_gen_passthrough:
                    passthrough = self.multiworld.re_gen_passthrough["Crash Bandicoot: Warped"]
